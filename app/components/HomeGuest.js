    ...
    switch (action.type) {
      ...
      case "usernameUniqueResults":
        if (action.value) {
          ...
          draft.username.message = "The username is already taken.";
        } else {
      ...
      case "emailUniqueResults":
        if (action.value) {
          ...
          draft.email.message = "The email is already being used.";
        } else {
      ...
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          ...
          <p className="lead text-muted">
            Are you sick of short tweets and impersonal &ldquo;shared&rdquo; posts that are reminiscent of the late 90&rsquo;s email forwards? We believe getting back to actually writing is the key to
